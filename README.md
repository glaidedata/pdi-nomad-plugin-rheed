# pdi-nomad-plugin-rheed

Parser and schema for RHEED data.
...
```sh
git clone https://github.com/glaidedata/pdi-nomad-plugin-rheed.git
cd pdi-nomad-plugin-rheed
...
| Name | E-mail     |
|------|------------|
| Joseph Rudzinski | [jfrudzinski@glaidedata.com](mailto:jfrudzinski@glaidedata.com)
